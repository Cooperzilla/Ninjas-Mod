...
public class KunaiItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (! world.isClient) {
            ...
            kunai.setVelocity(user, user.getPitch(), user.getYaw(), 0.0F, 2.5F, 0F);
        ...
        user.getItemCooldownManager().set(this, (int) Math.floor((18 * 100) / user.getAttributeValue(Registries.ATTRIBUTE.get(new Identifier("ranged_weapon:haste")))));
