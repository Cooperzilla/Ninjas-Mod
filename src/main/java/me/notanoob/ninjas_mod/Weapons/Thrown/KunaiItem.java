...
public class KunaiItem extends SwordItem {
    public KunaiItem() {
        super(ToolMaterials.IRON, 1, -2f, new Settings());
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (! world.isClient) {
            ...
            KunaiEntity entity = new KunaiEntity(world, user, (float) attr.getValue());
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("item.ninjas.kunai.tooltip").formatted(Formatting.DARK_GREEN));
    }
}
